...
export const metadata: Metadata = {
  title: 'CinemaSync - Watch Together',
  description: 'Watch movies together in perfect sync with friends. Create rooms, join watch parties, and enjoy synchronized viewing experiences.',
  generator: 'CinemaSync',
...
html {
  ...
  --font-mono: ${GeistMono.variable};
        ...
        `}</style>
        {/* PWA Meta Tags */}
        <meta name="application-name" content="CinemaSync" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta name="apple-mobile-web-app-title" content="CinemaSync" />
